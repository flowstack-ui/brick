...
export type ComboboxControlProps = HTMLAttributes<HTMLDivElement> & { "data-slot"?: string };
...
export const ComboboxControl = forwardRef<HTMLDivElement, ComboboxControlProps>(function ComboboxControl({ className, "data-slot": dataSlot, ...props }, ref) {
  ...
  return <div {...props} className={cn("brick-combobox-control", className)} data-full-width={visual.fullWidth ? "" : undefined} data-shape={visual.shape} data-size={visual.size} data-slot={slot(dataSlot, "combobox-control")} data-variant={visual.variant} ref={ref} />;
});
...
export const Combobox = Object.freeze({ Root: ComboboxRoot, Label: ComboboxLabel, Control: ComboboxControl, Input: ComboboxInput, Clear: ComboboxClear, Indicator: ComboboxIndicator, Portal: ComboboxPortal, Content: ComboboxContent, Listbox: ComboboxListbox, Group: ComboboxGroup, Item: ComboboxItem, Empty: ComboboxEmpty, Loading: ComboboxLoading });
