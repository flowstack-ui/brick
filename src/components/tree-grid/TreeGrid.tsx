...
export interface TreeGridColumnHeaderProps extends Omit<AtomTreeGridColumnHeaderProps, "align"> { align?: TreeGridCellAlign; verticalAlign?: TreeGridCellVerticalAlign; numeric?: boolean; }
export interface TreeGridRowHeaderProps extends Omit<AtomTreeGridRowHeaderProps, "align"> { align?: TreeGridCellAlign; verticalAlign?: TreeGridCellVerticalAlign; numeric?: boolean; }
export interface TreeGridCellProps extends Omit<AtomTreeGridCellProps, "align"> { align?: TreeGridCellAlign; verticalAlign?: TreeGridCellVerticalAlign; numeric?: boolean; }
...
export const TreeGridColumnHeader = forwardRef<HTMLTableCellElement, TreeGridColumnHeaderProps>(function TreeGridColumnHeader({ align, verticalAlign = "middle", numeric = false, className, "data-slot": dataSlot, ...props }, ref) {
  return <AtomTreeGrid.ColumnHeader {...props} className={mergeClassName("brick-tree-grid__column-header", className)} data-align={alignment(align, numeric)} data-numeric={numeric ? "" : undefined} data-slot={slot(dataSlot, "tree-grid-column-header")} data-vertical-align={verticalAlign} ref={ref} />;
});
export const TreeGridRowHeader = forwardRef<HTMLTableCellElement, TreeGridRowHeaderProps>(function TreeGridRowHeader({ align, verticalAlign = "middle", numeric = false, className, "data-slot": dataSlot, ...props }, ref) {
  return <AtomTreeGrid.RowHeader {...props} className={mergeClassName("brick-tree-grid__row-header", className)} data-align={alignment(align, numeric)} data-numeric={numeric ? "" : undefined} data-slot={slot(dataSlot, "tree-grid-row-header")} data-vertical-align={verticalAlign} ref={ref} />;
});
export const TreeGridCell = forwardRef<HTMLTableCellElement, TreeGridCellProps>(function TreeGridCell({ align, verticalAlign = "middle", numeric = false, className, "data-slot": dataSlot, ...props }, ref) {
  return <AtomTreeGrid.Cell {...props} className={mergeClassName("brick-tree-grid__cell", className)} data-align={alignment(align, numeric)} data-numeric={numeric ? "" : undefined} data-slot={slot(dataSlot, "tree-grid-cell")} data-vertical-align={verticalAlign} ref={ref} />;
});
