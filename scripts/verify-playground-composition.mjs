...
const expectedRouteIds = [
  ...
  "pagination", "password-toggle-field", "reorderable-list", "show", "skeleton", "skip-link", "stack", "section", "frame", "surface", "swipeable-item", "switch", "table", "tabs", "text", "toast", "toggle", "toggle-group", "toolbar", "tooltip", "tree", "tree-grid",
