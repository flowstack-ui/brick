export const componentDocumentationContracts = {
  ...
  chip: {
    ...
    dataAttributes: ["data-disabled", "data-shape", "data-size", "data-slot", "data-tone", "data-variant"],
    publicTokens: [
  ...
  tabs: {
    ...
    exports: ["Tabs", "TabsContent", "TabsContentInset", "TabsContentProps", "TabsIndicator", "TabsIndicatorProps", "TabsLayout", "TabsList", "TabsListProps", "TabsRoot", "TabsRootProps", "TabsSize", "TabsTrigger", "TabsTriggerProps", "TabsVariant"],
    unions: { TabsSize: ["sm", "md", "lg"], TabsVariant: ["line", "solid", "soft", "enclosed"], TabsContentInset: ["none", "sm", "md", "lg"], TabsLayout: ["auto", "stacked", "side"] },
    defaults: { size: "md", variant: "line", fullWidth: false, layout: "auto" },
    dataAttributes: ["data-full-width", "data-size", "data-variant", "data-inset", "data-layout"],
  ...
  toggle: {
    ...
    exports: ["Toggle", "ToggleProps", "ToggleShape", "ToggleSize", "ToggleTone", "ToggleVariant"],
    unions: {
    ...
    dataAttributes: ["data-icon-only", "data-shape", "data-size", "data-tone", "data-variant"],
    publicTokens: [
  ...
  "tree-grid": {
    ...
    exports: ["TreeGrid", "TreeGridBody", "TreeGridBodyProps", "TreeGridCaption", "TreeGridCaptionProps", "TreeGridCaptionSide", "TreeGridCell", "TreeGridCellAlign", "TreeGridCellProps", "TreeGridColumnHeader", "TreeGridColumnHeaderProps", "TreeGridContainer", "TreeGridContainerProps", "TreeGridDensity", "TreeGridFooter", "TreeGridFooterProps", "TreeGridHeader", "TreeGridHeaderProps", "TreeGridIndicator", "TreeGridIndicatorProps", "TreeGridRoot", "TreeGridRootProps", "TreeGridRow", "TreeGridRowHeader", "TreeGridRowHeaderProps", "TreeGridRowProps", "TreeGridSize", "TreeGridSortIndicator", "TreeGridSortIndicatorProps", "TreeGridVariant"],
    unions: { TreeGridVariant: ["line", "outline"], TreeGridSize: ["sm", "md", "lg"], TreeGridDensity: ["compact", "comfortable", "spacious"], TreeGridCaptionSide: ["top", "bottom"], TreeGridCellAlign: ["start", "center", "end"] },
    defaults: { variant: "line", size: "md", density: "comfortable", side: "bottom" },
    dataAttributes: ["data-align", "data-density", "data-numeric", "data-side", "data-size", "data-slot", "data-variant"],
    publicTokens: ["--brick-tree-grid-inline-size", "--brick-tree-grid-min-inline-size", "--brick-tree-grid-border-color", "--brick-tree-grid-border-width", "--brick-tree-grid-radius", "--brick-tree-grid-header-background", "--brick-tree-grid-header-foreground", "--brick-tree-grid-body-background", "--brick-tree-grid-footer-background", "--brick-tree-grid-cell-foreground", "--brick-tree-grid-cell-padding-inline", "--brick-tree-grid-cell-padding-block", "--brick-tree-grid-row-min-block-size", "--brick-tree-grid-depth-indent", "--brick-tree-grid-caption-foreground", "--brick-tree-grid-caption-gap", "--brick-tree-grid-active-color", "--brick-tree-grid-active-width", "--brick-tree-grid-selected-background", "--brick-tree-grid-selected-foreground", "--brick-tree-grid-hover-background", "--brick-tree-grid-disabled-opacity", "--brick-tree-grid-indicator-size", "--brick-tree-grid-indicator-color", "--brick-tree-grid-sort-indicator-size", "--brick-tree-grid-sort-indicator-color", "--brick-tree-grid-motion-duration", "--brick-tree-grid-motion-easing"],
  },
  tree: {
  ...
  text: {
    ...
    unions: {
      ...
      ParagraphVariant: ["body-lg", "body-md", "body-sm"],
    },
    documentedValues: {
      lineClamp: [2, 3, 4, 5, 6],
    },
  ...
  frame: {
    ...
    exports: ["Frame", "FrameElement", "FrameLength", "FrameProps", "ResponsiveValue"],
    unions: {
      FrameElement: ["div", "span", "section", "article", "aside", "main", "header", "footer", "nav", "ul", "ol", "li"],
    },
  ...
  prose: {
    ...
    exports: ["Prose", "ProseElement", "ProseMeasure", "ProseProps", "ProseSize"],
    unions: {
    ...
    publicTokens: [
      "--brick-prose-measure", "--brick-prose-flow-space", "--brick-prose-section-space",
      "--brick-prose-foreground", "--brick-prose-muted-foreground", "--brick-prose-link-foreground",
      "--brick-prose-accent", "--brick-prose-border-color", "--brick-prose-surface",
      "--brick-prose-body-font-family", "--brick-prose-body-font-size", "--brick-prose-body-font-weight",
      "--brick-prose-body-line-height", "--brick-prose-body-letter-spacing",
      "--brick-prose-heading-font-family", "--brick-prose-heading-font-weight", "--brick-prose-heading-letter-spacing",
      "--brick-prose-code-font-family", "--brick-prose-code-font-size", "--brick-prose-code-radius",
      "--brick-prose-media-radius", "--brick-prose-table-cell-padding-block", "--brick-prose-table-cell-padding-inline",
    ],
  },
  "code-block": {
    ...
    exports: [
      "CodeBlock", "CodeBlockAdapter", "CodeBlockAdapterContext",
      "CodeBlockActions", "CodeBlockActionsProps",
      "CodeBlockCollapse", "CodeBlockCollapseProps", "CodeBlockCollapsePreview",
      "CodeBlockCollapsePreviewProps", "CodeBlockCollapseContent",
      "CodeBlockCollapseContentProps", "CodeBlockCollapseTrigger",
      ...
      "CodeBlockLanguage", "CodeBlockLanguageProps", "CodeBlockLine",
      "CodeBlockLineChange", "CodeBlockLineProps", "CodeBlockRoot",
    ...
    dataAttributes: ["data-change", "data-focused", "data-highlighted", "data-language", "data-line-number", "data-max-lines", "data-size", "data-slot", "data-variant", "data-wrap"],
    publicTokens: [
      ...
      "--brick-code-block-content-padding", "--brick-code-block-content-padding-block",
      ...
      "--brick-code-block-selection-foreground", "--brick-code-block-max-block-size",
      "--brick-code-block-line-number-foreground", "--brick-code-block-line-number-width",
      "--brick-code-block-line-highlight-background", "--brick-code-block-line-focus-background",
      "--brick-code-block-line-added-background", "--brick-code-block-line-added-border",
      "--brick-code-block-line-removed-background", "--brick-code-block-line-removed-border",
    ],
  },
  card: {
...
componentDocumentationContracts["navigation-menu"] = {
  ...
  exports: ["NavigationMenu","NavigationMenuRoot","NavigationMenuSub","NavigationMenuList","NavigationMenuItem","NavigationMenuTrigger","NavigationMenuContent","NavigationMenuLink","NavigationMenuIndicator","NavigationMenuViewport","NavigationMenuRootProps","NavigationMenuSubProps","NavigationMenuListProps","NavigationMenuItemProps","NavigationMenuTriggerProps","NavigationMenuContentProps","NavigationMenuLinkProps","NavigationMenuIndicatorProps","NavigationMenuViewportProps","NavigationMenuSize","NavigationMenuLinkVariant"],
  unions: { NavigationMenuSize: ["sm", "md", "lg"], NavigationMenuLinkVariant: ["control", "panel"] },
...
componentDocumentationContracts["color-swatch"] = {
  ...
  exports: [
    ...
    "ColorSwatchRoot", "ColorSwatchRootProps", "ColorSwatchShape",
    "ColorSwatchSize",
  ],
  unions: {
...
componentDocumentationContracts["color-picker"] = {
  ...
  exports: [
    "ColorPicker", "ColorPickerArea", "ColorPickerAreaBackground",
    "ColorPickerAreaBackgroundProps", "ColorPickerAreaProps",
    "ColorPickerAreaThumb", "ColorPickerAreaThumbProps",
    "ColorPickerChannelInput", "ColorPickerChannelInputProps",
    "ColorPickerChannelSlider", "ColorPickerChannelSliderLabel",
    "ColorPickerChannelSliderLabelProps", "ColorPickerChannelSliderProps",
    "ColorPickerChannelSliderThumb", "ColorPickerChannelSliderThumbProps",
    "ColorPickerChannelSliderTrack", "ColorPickerChannelSliderTrackProps",
    "ColorPickerChannelSliderValueText",
    "ColorPickerChannelSliderValueTextProps", "ColorPickerContent",
    "ColorPickerContentProps", "ColorPickerContext", "ColorPickerContextProps",
    "ColorPickerControl", "ColorPickerControlLayout", "ColorPickerControlProps",
    "ColorPickerEyeDropperTrigger", "ColorPickerEyeDropperTriggerProps",
    "ColorPickerFormatSelect", "ColorPickerFormatSelectProps",
    "ColorPickerFormatTrigger", "ColorPickerFormatTriggerProps",
    "ColorPickerHiddenInput", "ColorPickerHiddenInputProps", "ColorPickerInput",
    "ColorPickerInputProps", "ColorPickerLabel", "ColorPickerLabelProps",
    "ColorPickerNativeInput", "ColorPickerNativeInputProps",
    "ColorPickerPositioner", "ColorPickerPositionerProps", "ColorPickerRoot",
    "ColorPickerRootProps", "ColorPickerSize", "ColorPickerSwatch",
    "ColorPickerSwatchFrame", "ColorPickerSwatchShape",
    "ColorPickerSwatchGroup", "ColorPickerSwatchGroupProps",
    "ColorPickerSwatchIndicator", "ColorPickerSwatchIndicatorProps",
    "ColorPickerSwatchProps", "ColorPickerSwatchTrigger",
    "ColorPickerSwatchTriggerProps", "ColorPickerTransparencyGrid",
    "ColorPickerTransparencyGridProps", "ColorPickerTrigger",
    "ColorPickerTriggerProps", "ColorPickerValueSwatch",
    "ColorPickerValueSwatchProps", "ColorPickerValueText",
    "ColorPickerValueTextProps", "ColorPickerVariant", "ColorPickerView",
  ...
  defaults: { size: "md", variant: "outline" },
  dataAttributes: ["data-size", "data-variant", "data-layout", "data-frame", "data-shape"],
  publicTokens: [
    ...
    "--brick-color-picker-content-shadow", "--brick-color-picker-area-block-size",
    "--brick-color-picker-checker-size", "--brick-color-picker-indicator-color",
    "--brick-color-picker-indicator-shadow", "--brick-color-picker-input-width",
    "--brick-color-picker-slider-block-size", "--brick-color-picker-swatch-gap",
    "--brick-color-picker-swatch-radius", "--brick-color-picker-swatch-size",
...
componentDocumentationContracts.toolbar = {
  ...
  exports: [
    ...
    "ToolbarToggleTone", "ToolbarToggleVariant", "ToolbarVariant",
  ],
  unions: {
...
componentDocumentationContracts.carousel = {
  ...
  exports: ["Carousel","CarouselRoot","CarouselViewport","CarouselTrack","CarouselSlide","CarouselNavigation","CarouselPrevious","CarouselNext","CarouselControls","CarouselRotationControl","CarouselPicker","CarouselPickerItem","CarouselRootProps","CarouselViewportProps","CarouselTrackProps","CarouselSlideProps","CarouselNavigationProps","CarouselPreviousProps","CarouselNextProps","CarouselControlsProps","CarouselRotationControlProps","CarouselPickerProps","CarouselPickerItemProps","CarouselSize","CarouselControlPlacement","CarouselControlSize","CarouselControlShape","CarouselControlVariant","CarouselNavigationVisibility","CarouselPickerVariant"],
  unions: { CarouselSize: ["sm", "md", "lg"], CarouselControlPlacement: ["overlay", "outside"], CarouselControlSize: ["xs", "sm", "md", "lg", "xl"], CarouselControlShape: ["rounded", "circle"], CarouselControlVariant: ["solid", "soft", "outline", "ghost"], CarouselNavigationVisibility: ["always", "interaction"], CarouselPickerVariant: ["surface", "bare"] },
  defaults: { size: "md", controlPlacement: "overlay", controlShape: "circle", controlVariant: "soft", visibility: "always", variant: "surface" },
  dataAttributes: ["data-control-placement", "data-control-shape", "data-control-variant", "data-shape", "data-size", "data-slot", "data-touch-navigation", "data-variant", "data-visibility"],
  publicTokens: ["--brick-carousel-gap","--brick-carousel-radius","--brick-carousel-control-size","--brick-carousel-control-radius","--brick-carousel-control-foreground","--brick-carousel-control-background","--brick-carousel-control-border-color","--brick-carousel-control-hover-background","--brick-carousel-control-shadow","--brick-carousel-focus-ring","--brick-carousel-picker-gap","--brick-carousel-picker-target-size","--brick-carousel-picker-background","--brick-carousel-picker-padding","--brick-carousel-picker-radius","--brick-carousel-dot-size","--brick-carousel-dot-background","--brick-carousel-dot-active-background","--brick-carousel-transition-duration","--brick-carousel-transition-easing"],
};
