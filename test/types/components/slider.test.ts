...
import { Slider, type SliderFrame, type SliderRootProps, type SliderSize, type SliderVariant } from "../../../src/slider.js";
import { Slider as RootSlider } from "../../../src/index.js";
const ref = createRef<HTMLDivElement>(); const sizes: SliderSize[] = ["sm", "md", "lg"]; const variants: SliderVariant[] = ["solid", "soft"]; const frames: SliderFrame[] = ["none", "outline"]; const props: SliderRootProps = { defaultValue: [20, 80], frame: "outline", size: "lg", variant: "soft" };
...
void sizes; void variants; void frames;
