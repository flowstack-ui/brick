...
test("the consumer uses public package exports without source aliases", async () => {
  ...
  assert.match(source, /import \{ Heading, Text \} from "@flowstack-ui\/brick\/text"/);
  assert.match(source, /@flowstack-ui\/brick\/link/);
  assert.match(source, /@flowstack-ui\/brick\/link-box/);
  ...
  assert.match(source, /@flowstack-ui\/brick\/skip-link/);
  assert.match(source, /@flowstack-ui\/brick\/toast/);
  assert.match(source, /@flowstack-ui\/brick\/toolbar/);
  assert.match(source, /@flowstack-ui\/brick\/pagination/);
  assert.match(source, /@flowstack-ui\/brick\/tree/);
  assert.match(source, /@flowstack-ui\/brick\/feed/);
  assert.match(source, /@flowstack-ui\/brick\/file-upload/);
