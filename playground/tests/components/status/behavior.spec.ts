...
test("keeps passive state text and decorative indicator semantics", async ({ page }) => {
  ...
  await expect(status.locator("[data-slot='status-indicator']")).toHaveAttribute("aria-hidden", "true");
