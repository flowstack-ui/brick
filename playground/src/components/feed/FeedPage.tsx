...
export function FeedPage() {
  ...
  return (
    <VStack className="feed-page" data-component-page="feed" gap="6">
      ...
      <Scenario {...feedScenarios[7]}><Grid.Root className="feed-specimens" columns={2} gap="4"><EvidenceSurface className="feed-cell" data-brick-appearance="light" data-testid="feed-light"><SpecimenLabel>Light</SpecimenLabel><ActivityStream items={updates.slice(0, 2)} prefix="light" variant="outline" /></EvidenceSurface><EvidenceSurface className="feed-cell" data-brick-appearance="dark" data-testid="feed-dark"><SpecimenLabel>Dark</SpecimenLabel><ActivityStream items={updates.slice(0, 2)} prefix="dark" variant="outline" /></EvidenceSurface></Grid.Root></Scenario>
