...
function DataTable({ caption = "Release verification", action = false, items = rows, ...props }: React.ComponentProps<typeof Table.Root> & { caption?: string; action?: boolean; items?: typeof rows }) {
