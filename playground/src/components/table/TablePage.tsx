...
export function TablePage() {
  ...
  return <VStack className="table-page" data-component-page="table" gap="6">
    ...
    <Scenario {...tableScenarios[6]}><Grid.Root className="table-grid table-sticky-grid" columns={3} gap="4"><Cell label="top caption"><Table.Root variant="outline"><Table.Caption>Caption above the data</Table.Caption><Table.Body><Table.Row><Table.Cell>Complete</Table.Cell></Table.Row></Table.Body></Table.Root></Cell><Cell label="footer"><Table.Root variant="outline"><Table.Body><Table.Row><Table.Cell>Completed checks</Table.Cell><Table.Cell numeric>238</Table.Cell></Table.Row></Table.Body><Table.Footer><Table.Row><Table.Head scope="row">Total</Table.Head><Table.Cell numeric>238</Table.Cell></Table.Row></Table.Footer></Table.Root></Cell><Cell label="sticky header"><div aria-label="Scrollable release inventory" className="table-sticky" tabIndex={0}><DataTable caption="Sticky release inventory" stickyHeader variant="outline" /></div></Cell></Grid.Root></Scenario>
    <Scenario {...tableScenarios[7]}><VStack gap="5"><Grid.Root className="table-grid table-grid--two" columns={2} gap="4"><EvidenceSurface data-brick-appearance="light"><SpecimenLabel>light</SpecimenLabel><DataTable /></EvidenceSurface><EvidenceSurface data-brick-appearance="dark"><SpecimenLabel>dark</SpecimenLabel><DataTable /></EvidenceSurface></Grid.Root><EvidenceSurface><Grid.Root className="table-customization" columns={2} gap="5"><VStack gap="2"><Text as="h3" variant="title-sm">Table CSS properties</Text><Text tone="secondary" variant="body-sm">The preview changes the border, header surface, and radius shown in code.</Text><PlaygroundCodeBlock>{`--brick-table-border-color: var(--brick-color-accent-border);\n--brick-table-header-background: var(--brick-color-accent-subtle);\n--brick-table-radius: 1rem;`}</PlaygroundCodeBlock></VStack><DataTable style={customStyle} variant="outline" caption="Customized release table" /></Grid.Root></EvidenceSurface></VStack></Scenario>
    <Scenario {...tableScenarios[8]}><VStack gap="5"><Text tone="secondary" variant="body-sm">Table stays native and static. Selection, cell navigation, filtering, resizing, editing, and virtualization belong to Data Grid.</Text><Cell label="responsive overflow"><Table.Container><DataTable action caption="Wide release inventory" style={{ "--brick-table-min-inline-size": "60rem" } as CSSProperties} /></Table.Container></Cell><Cell label="RTL logical layout"><div dir="rtl"><Table.Container><RtlTable /></Table.Container></div></Cell></VStack></Scenario>
  </VStack>;
}
