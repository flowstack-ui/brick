...
export function ChipPage() {
  return <VStack className="chip-page" data-component-page="chip" gap="6">
    ...
    <Scenario {...chipScenarios[1]}><VStack gap="4"><Cell label="three public parts"><Standard variant="outline" /></Cell><RenderedOutput label="Rendered Chip HTML"><Standard variant="outline" /></RenderedOutput></VStack></Scenario>
