...
import { Field, Grid, Rating, VStack } from "@flowstack-ui/brick";
...
export function RatingPage(){return <VStack className="forms-page rating-page" data-component-page="rating">
 ...
 <Scenario {...ratingScenarios[4]}><Grid.Root columns={2} className="forms-grid forms-grid--two" data-testid="rating-input"><Cell label="stable selection"><Example label="Try pointer, touch, drag, or arrow keys" defaultValue={2}/></Cell><Cell label="optional clear"><Example label="Activate the selected value to clear" defaultValue={2} allowClear/></Cell></Grid.Root></Scenario>
 ...
 <Scenario {...ratingScenarios[7]}><VStack className="forms-evidence-stack"><EvidenceGroup title="Scoped appearances" description="The same rating follows semantic surface and accent tokens."><Grid.Root columns={2} className="forms-scoped-grid" data-testid="rating-appearance"><EvidenceSurface data-brick-appearance="light"><SpecimenLabel>Light</SpecimenLabel><Example/></EvidenceSurface><EvidenceSurface data-brick-appearance="dark"><SpecimenLabel>Dark</SpecimenLabel><Example/></EvidenceSurface></Grid.Root></EvidenceGroup><EvidenceGroup title="Consumer customization" description="Violet fill, lavender empty artwork, and larger stars come from the exact properties shown."><EvidenceSurface className="playground-customization-evidence" data-testid="rating-customization" inset="none"><Grid.Root className="playground-customization-layout" columns={2} gap="0"><VStack gap="2"><SpecimenLabel>Customized</SpecimenLabel><PlaygroundCodeBlock aria-label="Rating customization code">{customCode}</PlaygroundCodeBlock></VStack><div className="playground-customization-preview"><Example style={customStyle}/></div></Grid.Root></EvidenceSurface></EvidenceGroup></VStack></Scenario>
