...
export function ProgressCirclePage() {
  return <VStack className="forms-page progress-circle-page" data-component-page="progress-circle" data-testid="progress-circle-workbench">
    ...
    <Scenario {...progressCircleScenarios[7]}><VStack className="forms-evidence-stack"><EvidenceGroup title="Scoped appearances" description="The same defaults use semantic track, text, and accent tokens."><Grid.Root columns={2} className="forms-scoped-grid" data-testid="progress-circle-appearance"><EvidenceSurface data-brick-appearance="light"><SpecimenLabel>Light</SpecimenLabel><CircleProgress /></EvidenceSurface><EvidenceSurface data-brick-appearance="dark"><SpecimenLabel>Dark</SpecimenLabel><CircleProgress /></EvidenceSurface></Grid.Root></EvidenceGroup><EvidenceGroup title="Consumer customization" description="The larger purple ring, lavender track, and custom stroke come from the exact properties shown."><EvidenceSurface className="forms-customization" data-testid="progress-circle-customization" inset="none"><VStack gap="2"><SpecimenLabel>Customized</SpecimenLabel><Text as="h4" variant="title-sm">Progress Circle CSS properties</Text><PlaygroundCodeBlock aria-label="Progress Circle customization code">{customCode}</PlaygroundCodeBlock></VStack><div className="forms-customization__preview"><CircleProgress style={customStyle} /></div></EvidenceSurface></EvidenceGroup></VStack></Scenario>
