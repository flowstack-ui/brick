...
export function MultiSelectPage() {
  ...
  return (
    <VStack className="forms-page multi-select-page" data-component-page="multi-select" data-testid="multi-select-workbench">
      ...
      <Scenario {...multiSelectScenarios[7]}><Grid.Root columns={3} className="forms-grid forms-grid--three" data-testid="multi-select-appearance"><Tile label="light"><div data-appearance="light"><SkillsMultiSelect id="multi-select-light" /></div></Tile><Tile label="dark"><div data-appearance="dark"><SkillsMultiSelect id="multi-select-dark" /></div></Tile><Tile label="customized"><SkillsMultiSelect id="multi-select-custom" style={customTokens} /><Text variant="caption">Trigger, popup, and highlight use documented Multi Select variables.</Text></Tile></Grid.Root></Scenario>
      <Scenario {...multiSelectScenarios[8]}><Grid.Root columns={2} className="forms-grid" data-testid="multi-select-stress"><Tile label="narrow and long"><div className="multi-select-narrow"><SkillsMultiSelect id="multi-select-long-text" label="Localized team disciplines with extended wording"><MultiSelect.Item value="collaboration"><MultiSelect.ItemText>Cross-functional collaboration and systems facilitation</MultiSelect.ItemText><MultiSelect.ItemIndicator /></MultiSelect.Item><MultiSelect.Item value="architecture"><MultiSelect.ItemText>Distributed platform architecture and reliability planning</MultiSelect.ItemText><MultiSelect.ItemIndicator /></MultiSelect.Item></SkillsMultiSelect></div></Tile><Tile label="RTL"><div dir="rtl"><SkillsMultiSelect id="multi-select-rtl" label="مهارات الفريق" /></div></Tile></Grid.Root></Scenario>
    </VStack>
  );
}
