...
export function IconPage() {
  return <VStack className="icon-page" data-component-page="icon">
    ...
    <Scenario {...iconScenarios[4]}><Grid.Root columns={3} className="icon-grid"><Cell label="inline SVG"><Icon><svg data-testid="icon-inline-source" viewBox="0 0 24 24"><path d="M5 12h14" fill="none" stroke="currentColor" strokeLinecap="round" strokeWidth="2"/><path d="m14 7 5 5-5 5" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"/></svg></Icon></Cell><Cell label="React component"><Icon><SearchGraphic /></Icon></Cell><Cell label="fixed multicolor"><Icon><BrandGraphic /></Icon></Cell></Grid.Root></Scenario>
    <Scenario {...iconScenarios[5]}><VStack gap="4"><Grid.Root columns={2} className="icon-grid"><Cell label="default wrapper"><Icon><SearchGraphic /></Icon></Cell><Cell label="SVG asChild"><Icon asChild tone="success"><svg data-source="composed" viewBox="0 0 24 24"><circle cx="12" cy="12" r="9" fill="none" stroke="currentColor" strokeWidth="2"/><path d="m8 12 2.5 2.5L16 9" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"/></svg></Icon></Cell><Cell label="inline with Text"><Text><Icon size="xs"><SearchGraphic /></Icon> Search projects</Text></Cell><Cell label="named controls"><HStack gap="3"><Button startIcon={<Icon size="xs"><SearchGraphic /></Icon>}>Search</Button><IconButton aria-label="Search"><Icon><SearchGraphic /></Icon></IconButton></HStack></Cell></Grid.Root><RenderedOutput label="Composed SVG HTML" previewLabel="SVG asChild"><Icon asChild tone="success"><svg data-testid="icon-rendered-composed" viewBox="0 0 24 24"><circle cx="12" cy="12" r="9" fill="none" stroke="currentColor" strokeWidth="2"/><path d="m8 12 2.5 2.5L16 9" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"/></svg></Icon></RenderedOutput></VStack></Scenario>
    ...
    <Scenario {...iconScenarios[7]}><VStack gap="4"><Grid.Root columns={2} className="icon-grid"><EvidenceSurface className="icon-cell" data-brick-appearance="light"><SpecimenLabel>Light</SpecimenLabel><div className="icon-cell__preview"><Icon tone="accent"><SearchGraphic /></Icon></div></EvidenceSurface><EvidenceSurface className="icon-cell" data-brick-appearance="dark"><SpecimenLabel>Dark</SpecimenLabel><div className="icon-cell__preview"><Icon tone="accent"><SearchGraphic /></Icon></div></EvidenceSurface></Grid.Root><EvidenceSurface className="playground-customization-evidence" inset="none"><Grid.Root columns={2} className="icon-customization playground-customization-layout" gap="0"><VStack gap="3"><Text as="h3" variant="title-sm">Icon CSS properties</Text><Text tone="secondary" variant="body-sm">The preview sets a custom 3rem size and purple foreground.</Text><PlaygroundCodeBlock tabIndex={0}>{`--brick-icon-size: 3rem;\n--brick-icon-color: #6b2f88;`}</PlaygroundCodeBlock></VStack><div className="icon-customization__preview"><Icon style={customStyle}><SearchGraphic /></Icon></div></Grid.Root></EvidenceSurface></VStack></Scenario>
