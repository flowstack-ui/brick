...
function ScopedPreview({ appearance }: { appearance: "light" | "dark" }) {
  ...
  return <EvidenceSurface className="hover-card-appearance-panel" data-brick-appearance={appearance} level="canvas" ref={setContainer}><SpecimenLabel>{appearance === "light" ? "Light" : "Dark"}</SpecimenLabel>{container ? <HoverCard.Root openDelay={0}><HoverCard.Trigger asChild><Link href={`/hover-card/destination?resource=${appearance}-profile`}>{appearance} profile</Link></HoverCard.Trigger><HoverCard.Portal container={container}><HoverCard.Content><Profile /><HoverCard.Arrow /></HoverCard.Content></HoverCard.Portal></HoverCard.Root> : null}</EvidenceSurface>;
}
...
>
  <Profile />
  <HoverCard.Arrow />
</HoverCard.Content>`}</PlaygroundCodeBlock></div><div className="hover-card-customization__preview"><HoverCard.Root openDelay={0}><HoverCard.Trigger asChild><Link href="/hover-card/destination?resource=custom-profile">Custom profile</Link></HoverCard.Trigger><HoverCard.Portal><HoverCard.Content className="custom-hover-card" data-slot="custom-hover-card" style={customTokens}><Profile /><HoverCard.Arrow /></HoverCard.Content></HoverCard.Portal></HoverCard.Root></div></EvidenceSurface></EvidenceGroup>
    </VStack></Scenario>
