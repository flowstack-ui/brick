...
export function TreeGridPage() {
  ...
  return <VStack className="tree-grid-page" data-component-page="tree-grid" gap="6">
    ...
    <Scenario {...treeGridScenarios[1]}><VStack gap="4"><Cell label="twelve-part composition"><TreeGrid.Container><FileGrid /></TreeGrid.Container></Cell><RenderedOutput label="Rendered Tree Grid HTML"><FileGrid footer={false} rows={files.slice(0, 2)} /></RenderedOutput></VStack></Scenario>
