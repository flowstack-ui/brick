...
export function SwipeableItemPage() {
  return (
    <VStack className="swipeable-page" data-component-page="swipeable-item" gap="6">
      ...
      <Scenario {...swipeableItemScenarios[1]}><Grid.Root className="swipeable-grid" columns={2} gap="4"><Cell label="three-part composition"><MessageItem /></Cell><RenderedOutput label="Rendered Swipeable Item HTML"><MessageItem /></RenderedOutput></Grid.Root></Scenario>
      ...
      <Scenario {...swipeableItemScenarios[4]}><EvidenceSurface inset="lg"><VStack gap="3"><Badge size="sm" tone="success">Dragging alternative</Badge><Text as="h3" variant="title-sm">Every command remains one click away</Text><Text as="p" tone="secondary" variant="body-sm">Open More actions to reach Archive and Delete without swiping.</Text><MessageItem /></VStack></EvidenceSurface></Scenario>
      ...
      <Scenario {...swipeableItemScenarios[7]}><Grid.Root className="swipeable-grid" columns={2} gap="4"><EvidenceSurface data-brick-appearance="light"><Badge size="sm">Light</Badge><MessageItem /></EvidenceSurface><EvidenceSurface data-brick-appearance="dark"><Badge size="sm">Dark</Badge><MessageItem /></EvidenceSurface></Grid.Root></Scenario>
      <Scenario {...swipeableItemScenarios[8]}><EvidenceSurface as="article" className="swipeable-customization" inset="lg"><VStack gap="2"><Badge size="sm" tone="accent">Customized</Badge><Text as="h3" variant="title-sm">Accent message actions</Text><Text as="p" tone="secondary" variant="body-sm">Public variables recolor both layers while the shared radius clips every translated edge.</Text><PlaygroundCodeBlock>{`--brick-swipeable-item-background: var(--brick-color-accent-soft);\n--brick-swipeable-item-action-background: var(--brick-color-accent-surface);\n--brick-swipeable-item-border-color: var(--brick-color-accent-border);\n--brick-swipeable-item-radius: 1.25rem;`}</PlaygroundCodeBlock></VStack><MessageItem style={customTokens} /></EvidenceSurface></Scenario>
