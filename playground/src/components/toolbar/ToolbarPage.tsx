...
export function ToolbarPage() {
  return <VStack className="toolbar-page" data-component-page="toolbar" gap="6">
    ...
    <Scenario {...toolbarScenarios[1]}><VStack gap="4"><Cell label="six public parts"><Standard variant="outline" /></Cell><RenderedOutput label="Rendered Toolbar HTML"><Standard variant="outline" /></RenderedOutput></VStack></Scenario>
