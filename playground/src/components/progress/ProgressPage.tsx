...
import { Grid, Progress, Text, VStack, type ProgressShape, type ProgressSize, type ProgressTone } from "@flowstack-ui/brick";
...
export function ProgressPage() {
  return <VStack className="forms-page progress-page" data-component-page="progress" data-testid="progress-workbench">
    ...
    <Scenario {...progressScenarios[7]}><VStack className="forms-evidence-stack"><EvidenceGroup title="Scoped appearances" description="The same defaults use semantic track, text, and accent tokens."><Grid.Root columns={2} className="forms-scoped-grid" data-testid="progress-appearance"><EvidenceSurface data-brick-appearance="light"><SpecimenLabel>Light</SpecimenLabel><LinearProgress /></EvidenceSurface><EvidenceSurface data-brick-appearance="dark"><SpecimenLabel>Dark</SpecimenLabel><LinearProgress /></EvidenceSurface></Grid.Root></EvidenceGroup><EvidenceGroup title="Consumer customization" description="The purple indicator, lavender track, thicker height, and tighter radius come from the exact properties shown."><EvidenceSurface className="forms-customization" inset="none"><VStack gap="2"><SpecimenLabel>Customized</SpecimenLabel><Text as="h4" variant="title-sm">Progress CSS properties</Text><PlaygroundCodeBlock aria-label="Progress customization code">{customCode}</PlaygroundCodeBlock></VStack><div className="forms-customization__preview"><LinearProgress style={customStyle} /></div></EvidenceSurface></EvidenceGroup></VStack></Scenario>
