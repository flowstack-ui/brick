...
import { Button, Field, FileUpload, Form, Grid, Text, VStack, type FileUploadShape, type FileUploadSize, type FileUploadVariant } from "@flowstack-ui/brick";
...
export function FileUploadPage() {
  ...
  return <VStack className="forms-page file-upload-page" data-component-page="file-upload">
    ...
    <Scenario {...fileUploadScenarios[7]}><VStack className="forms-evidence-stack" data-testid="file-upload-appearance"><EvidenceGroup title="Scoped appearances" description="Compact badges identify the same File Upload defaults inside light and dark scopes."><Grid.Root columns={2} className="forms-scoped-grid"><EvidenceSurface data-brick-appearance="light"><SpecimenLabel>Light</SpecimenLabel><Labeled id="file-upload-light"><Upload defaultFiles={[receipt]} /></Labeled></EvidenceSurface><EvidenceSurface data-brick-appearance="dark"><SpecimenLabel>Dark</SpecimenLabel><Labeled id="file-upload-dark"><Upload defaultFiles={[receipt]} /></Labeled></EvidenceSurface></Grid.Root></EvidenceGroup><EvidenceGroup title="Consumer customization" description="The titled preview uses only documented File Upload variables."><EvidenceSurface as="article" className="forms-customization" inset="lg"><div><SpecimenLabel>Customized</SpecimenLabel><Text as="h4" variant="title-sm">Violet attachment area</Text><Text as="p" tone="secondary" variant="body-sm">A scoped surface, border, action, and radius distinguish one upload.</Text><PlaygroundCodeBlock tabIndex={0}>{`--brick-file-upload-background: #f5f3ff;\n--brick-file-upload-border: #7c3aed;\n--brick-file-upload-trigger-background: #6d28d9;\n--brick-file-upload-radius: 1rem;`}</PlaygroundCodeBlock></div><EvidenceSurface className="forms-customization__preview"><Labeled id="file-upload-custom"><Upload style={customTokens} /></Labeled></EvidenceSurface></EvidenceSurface></EvidenceGroup></VStack></Scenario>
