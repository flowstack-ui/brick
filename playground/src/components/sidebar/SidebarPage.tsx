...
export function SidebarPage() {
  ...
  return <VStack className="sidebar-page" data-component-page="sidebar">
    ...
    <Scenario {...sidebarScenarios[7]}><VStack gap="4"><Grid.Root columns={2} className="sidebar-grid"><EvidenceSurface data-brick-appearance="light" inset="none"><Shell /></EvidenceSurface><EvidenceSurface data-brick-appearance="dark" inset="none"><Shell /></EvidenceSurface></Grid.Root><EvidenceSurface><VStack gap="3"><Text as="h3" variant="title-sm">Sidebar CSS properties</Text><Text tone="secondary" variant="body-sm">A narrower panel, larger gap, and sticky offset use documented variables.</Text><PlaygroundCodeBlock tabIndex={0}>--brick-sidebar-expanded-width-md; --brick-sidebar-panel-gap; --brick-sidebar-sticky-offset</PlaygroundCodeBlock><Shell position="sticky" style={custom} variant="floating" /></VStack></EvidenceSurface></VStack></Scenario>
    <Scenario {...sidebarScenarios[8]}><Container gutter="sm" measure="narrow"><VStack gap="4"><Cell label="narrow floating right"><Shell main="لوحة المشروع ذات المحتوى الطويل" side="right" style={{ "--brick-sidebar-expanded-width-md": "10rem" } as CSSProperties} variant="floating" /></Cell><Cell label="named rail controls"><Shell compact defaultState="rail" collapsedState="rail" /></Cell></VStack></Container></Scenario>
  </VStack>;
}
