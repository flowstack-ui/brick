...
export function SidebarPage() {
  ...
  return <VStack className="sidebar-page" data-component-page="sidebar">
    ...
    <Scenario {...sidebarScenarios[7]}><VStack gap="4"><Grid.Root columns={2} className="sidebar-grid"><EvidenceSurface className="sidebar-cell" data-brick-appearance="light"><SpecimenLabel>Light</SpecimenLabel><Shell /></EvidenceSurface><EvidenceSurface className="sidebar-cell" data-brick-appearance="dark"><SpecimenLabel>Dark</SpecimenLabel><Shell /></EvidenceSurface><EvidenceSurface className="sidebar-cell" level="subtle"><SpecimenLabel>Transparent panel</SpecimenLabel><Shell surface="transparent" /></EvidenceSurface></Grid.Root><EvidenceSurface className="playground-customization-evidence" inset="none"><Grid.Root className="playground-customization-layout" columns={2} gap="0"><VStack gap="2"><SpecimenLabel>Customized</SpecimenLabel><Text as="h3" variant="title-sm">Sidebar CSS properties</Text><Text tone="secondary" variant="body-sm">A narrower panel, larger gap, and sticky offset use the documented variables shown here.</Text><PlaygroundCodeBlock tabIndex={0}>{`.custom-sidebar {
