...
export function ComboboxPage() {
  ...
  return <VStack className="combobox-page" data-component-page="combobox" gap="6">
    ...
    <Scenario {...comboboxScenarios[1]}><VStack gap="4"><Cell label="fourteen public parts"><Example /></Cell><RenderedOutput label="Rendered Combobox HTML"><Example /></RenderedOutput></VStack></Scenario>
