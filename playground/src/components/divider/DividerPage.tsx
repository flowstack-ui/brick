...
export function DividerPage() {
  ...
  return <VStack className="divider-page" data-component-page="divider">
    ...
    <Scenario {...dividerScenarios[7]}><VStack gap="4" data-testid="divider-appearance"><Grid.Root columns={2} className="divider-grid"><EvidenceSurface className="divider-cell" data-brick-appearance="light"><SpecimenLabel>Light</SpecimenLabel><ContentPair divider={<Divider />} /></EvidenceSurface><EvidenceSurface className="divider-cell" data-brick-appearance="dark"><SpecimenLabel>Dark</SpecimenLabel><ContentPair divider={<Divider />} /></EvidenceSurface></Grid.Root><EvidenceSurface as="article" className="playground-customization-evidence" inset="none"><Grid.Root className="playground-customization-layout" columns={2} gap="0"><VStack gap="2"><SpecimenLabel>Customized</SpecimenLabel><Text as="h3" variant="title-sm">Divider CSS properties</Text><Text tone="secondary" variant="body-sm">Accent color, larger inset, and label gap use documented public variables.</Text><PlaygroundCodeBlock tabIndex={0}>{`--brick-divider-color: var(--brick-color-accent-border);\n--brick-divider-inset: 2rem;\n--brick-divider-label-gap: 1rem;`}</PlaygroundCodeBlock></VStack><div className="playground-customization-preview"><Divider style={customStyle}>custom boundary</Divider></div></Grid.Root></EvidenceSurface></VStack></Scenario>
