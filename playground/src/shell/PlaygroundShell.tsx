  ...
  return (
    <div className="evidence-app" data-playground-shell="" id="top">
      ...
      <AppBar.Root
        ...
        position="sticky"
      >
        <Container gutter="lg" measure="max">
          <AppBar.Toolbar density="compact" inset="none">
            <AppBar.Start>
              <Link
                className="evidence-brand"
                href="/button"
                tone="inherit"
                variant="plain"
              >
                ...
                >
                  <Stack.Item flex={{ initial: "content", md: 1 }}>
                    <VStack className="evidence-page-heading" gap="2">
                      <Text className="playground-kicker" variant="caption">
                        @flowstack-ui/brick
                      </Text>
                  ...
                  <Frame
                    className="review-controls-frame"
                    inlineSize={{ initial: "100%", md: "max-content" }}
                    maxInlineSize="100%"
                  >
                    <ReviewControls
