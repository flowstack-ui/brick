...
1. Review 01–06 with pointer, touch, arrows, Page Up/Down, Home, and End. Confirm range thumbs never cross, dependent ARIA bounds update, vertical and RTL axes are correct, and every target is at least 44px.
