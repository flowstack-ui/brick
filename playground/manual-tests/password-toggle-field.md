...
Setup: Review 01–05. Action: Compare recipes and toggle default and localized examples by pointer and keyboard. Expected: Text never shifts, artwork stays centered, focus remains visible, and action names always describe the next action. Result:
Notes or issue:
